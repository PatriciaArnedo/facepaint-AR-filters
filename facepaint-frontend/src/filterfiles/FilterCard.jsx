          ...
          {this.props.belongsToUser ? (
            this.props.isSavedFilter ? (
              <NavLink
                ...
                to={`/user/${this.props.filterObj.id_user}`}
              >
            ...
            this.props.isOtherSavedFilter ? (
              ...
              <strong className="filter-username">
                @{this.props.filterObj.username}
              </strong>
            )
          ) : (
            <NavLink
              className="filter-username"
              to={`/user/${this.props.filterObj.user.id}`}
            >
              <strong>@{this.props.filterObj.username}</strong>
            </NavLink>
          )}

          <span className="filter-name">{this.props.filterObj.name}</span>
        </div>
      </div>
    );
  }
