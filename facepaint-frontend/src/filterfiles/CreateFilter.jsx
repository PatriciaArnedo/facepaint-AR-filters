...
class CreateFilter extends React.Component {
  ...
  setAtrament = () => {
    ...
    this.state.atrament.addEventListener("strokerecorded", ({ stroke }) =>
      this.setState({ points: stroke.points.length }),
    );
  };
        ...
        <div className="drawing-form-card">
          <form className="drawing-form" style={{ display: "inline-block" }}>
            ...
            <Button
              ...
              id="form-input"
              onClick={this.canvasClearClickHandler}
              label="Clear Canvas"
            />
            <Button
              id="form-input"
