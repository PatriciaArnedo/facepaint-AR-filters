...
import {
  setEventListnerEnabled,
  cameraShutdown,
} from "../camerafiles/FaceFilterSource";
...
class Header extends React.Component {
    ...
    items: [
      {
        ...
        command: () => this.clickHandler("home"),
      },
      {
        label: "My Filters",
        icon: "pi pi-fw pi-palette",
        command: () => this.clickHandler("gallery"),
      },
      {
        label: "Saved Filters",
        icon: "pi pi-fw pi-bookmark",
        command: () => this.clickHandler("saved"),
      },
      {
        label: "Discover Artists",
        icon: "pi pi-fw pi-eye",
        command: () => this.clickHandler("discover"),
      },
    ],
    showModal: false,
  };
  ...
  avatarOnClick = () => {
    ...
    cameraShutdown().then(console.log("camera shut down")).catch(console.log);
  };
    ...
    return (
      <div className="header-container">
        <div className="header">
          <img
            onClick={this.appNameClicker}
            className="app-name"
            src="https://i.imgur.com/9g07Wkk.png"
            alt="facepaint written in colorful letters"
          />
